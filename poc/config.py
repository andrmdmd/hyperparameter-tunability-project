...
ML_MODELS = {
    ...
    "xgboost": {
        "class": XGBClassifier,
        "hyperparameters": {
            "n_estimators": {"type": "int", "low": 921, "high": 4551},  # nrounds (rounded from 920.7, 4550.95)
    ...
    # # Gradient Boosting (booster in the table)
    # "gradient_boosting": {
    #     "class": GradientBoostingClassifier,
    #     "hyperparameters": {
    #         "max_depth": {"type": "int", "low": 6, "high": 14},  # max_depth
    #         "min_samples_leaf": {"type": "int", "low": 1, "high": 27},  # min_child_weight equivalent
    #         "subsample": {"type": "float", "low": 0.545, "high": 0.958},
    #         "n_estimators": {"type": "int", "low": 206, "high": 1740},  # num.trees
    #         "learning_rate": {"type": "float", "low": 0.008, "high": 29.755, "log": True},  # lambda (learning rate)
    #         "min_samples_split": {"type": "int", "low": 5, "high": 49},
    #     },
    # },
}
